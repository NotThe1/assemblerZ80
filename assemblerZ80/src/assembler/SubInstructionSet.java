...
public class SubInstructionSet {
	...
	private void appInit() {
		...
		// SBC
		baseCodes = new byte[] { (byte) 0XDD, (byte) 0X9E, (byte) 0X00 };
		subInstructions.put("SBC_1", new SubInstruction("SBC_1", Z80.LIT_A, Z80.IND_XYd, baseCodes));

		baseCodes = new byte[] { (byte) 0X98 };
		subInstructions.put("SBC_2", new SubInstruction("SBC_2", Z80.LIT_A, Z80.R_MAIN, baseCodes));

		baseCodes = new byte[] { (byte) 0XDE, (byte) 0X00 };
		subInstructions.put("SBC_3", new SubInstruction("SBC_3", Z80.LIT_A, Z80.EXP, baseCodes));

		baseCodes = new byte[] { (byte) 0XED, (byte) 0X42 };
		subInstructions.put("SBC_4", new SubInstruction("SBC_4", Z80.LIT_HL, Z80.R16_SP, baseCodes));
